...
Globalize.a1955158194 = messageFormatterFn((function(  ) {
  return function(d) { return "Describe your task or ask a question and let Tableau AI create a viz for you."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1619874501 = messageFormatterFn((function(  ) {
  return function(d) { return "Indexing complete."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1989661345 = messageFormatterFn((function(  ) {
  return function(d) { return "Indexing your data. This may take a minute..."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1562835982 = messageFormatterFn((function(  ) {
  return function(d) { return "Describe your task or ask a question and let Tableau AI create a viz for you."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1313922029 = messageFormatterFn((function(  ) {
  return function(d) { return "Welcome to Einstein"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b572280068 = messageFormatterFn((function(  ) {
...
Globalize.b1068564784 = messageFormatterFn((function(  ) {
  return function(d) { return "Three ways to add more data"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a841480749 = messageFormatterFn((function(  ) {
  return function(d) { return "Join or union"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1665801758 = messageFormatterFn((function(  ) {
  return function(d) { return "Address Preview"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1289540052 = messageFormatterFn((function(  ) {
  return function(d) { return "Full Address"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a974471385 = messageFormatterFn((function(  ) {
  return function(d) { return "Specify the fields that require geocoding:"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1023725659 = messageFormatterFn((function(  ) {
  return function(d) { return "Type a field name. Example: Address, City"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a593107502 = messageFormatterFn((function(  ) {
  return function(d) { return "Field not found in data source: "; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1519377730 = messageFormatterFn((function(  ) {
  return function(d) { return "Address string configuration applied."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b929268006 = messageFormatterFn((function(  ) {
  return function(d) { return "Use the Address Builder to string together fields in the data and construct the addresses for geocoding."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1542910289 = messageFormatterFn((function(  ) {
  return function(d) { return "Drag the tables containing address data onto the model editor to start the Geocoding process."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b961908193 = messageFormatterFn((function(  ) {
  return function(d) { return "number"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1575426841 = messageFormatterFn((function(  ) {
  return function(d) { return "string"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1426630731 = messageFormatterFn((function(  ) {
  return function(d) { return "Preview the strings that will be geocoded in the \"Address Prevew\" tab below."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b987339524 = messageFormatterFn((function(  ) {
  return function(d) { return "Apply"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b893709215 = messageFormatterFn((function(  ) {
  return function(d) { return "Address Builder"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1645884756 = messageFormatterFn((function(  ) {
  return function(d) { return d.tableName + " field Table Tab"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b457552600 = messageFormatterFn((function(  ) {
  return function(d) { return d.tableName + " Table Tab"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1091873993 = messageFormatterFn((function(  ) {
  return function(d) { return d.tableName + " custom SQL Table Tab"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1225210268 = messageFormatterFn((function(  ) {
  return function(d) { return "Abandon changes"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1958790851 = messageFormatterFn((function(  ) {
  return function(d) { return "You've made changes. Are you sure you want to abandon them?"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a771304605 = messageFormatterFn((function(  ) {
  return function(d) { return "Continue working"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1172484421 = messageFormatterFn((function(  ) {
  return function(d) { return "Abandon changes"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a325654510 = messageFormatterFn((function(  ) {
  return function(d) { return "This tool uses generative AI to draft an asset description. Generative AI can produce inacurate or harmful responses. Check the output before using " + d.learnMoreLink; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1557302937 = messageFormatterFn((function(  ) {
  return function(d) { return "Type an asset description or have Einstein draft one for you."; }
})(), Globalize("en").pluralGenerator({}));
